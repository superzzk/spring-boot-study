package com.zzk.spring.core.naming;

import com.zzk.spring.core.naming.component.Cat;
import com.zzk.spring.core.naming.component.Dog;
import com.zzk.spring.core.naming.service.PetShow;
...
public class SpringBeanNamingUnitTest {
    ...
    void setUp() {
        ...
        context.scan("com.zzk.spring.core.naming");
        context.refresh();
    }
